...
def search_papers(topic: str, max_results: int = 5) -> list[str]:
    ...
    """
    return arxiv_tools.search_papers(topic, max_results, paper_dir=PAPER_DIR)
...
def extract_info(paper_id: str) -> str:
    ...
    """
    return arxiv_tools.extract_info(paper_id, paper_dir=PAPER_DIR)
...
def get_topic_papers(topic: str) -> str:
    ...
    """
    return arxiv_tools.topic_papers_markdown(topic, paper_dir=PAPER_DIR)


@mcp.prompt()
def generate_search_prompt(topic: str, num_papers: int = 5) -> str:
    """Generate a prompt for Claude to find and discuss academic papers."""
    return arxiv_tools.generate_search_prompt(topic, num_papers)
